...
public class Empresas  implements java.io.Serializable {
     ...
     private Set conectorAdaptadors = new HashSet(0);
    ...
    public Empresas(String nombre, String status, String idTipo, String idNumero) {
        this.nombre = nombre;
        this.status = status;
        this.idTipo = idTipo;
        this.idNumero = idNumero;
    }
    public Empresas(String nombre, String status, String keyEmpresa, String email, String nombreArchivoLogo, String nombreContacto, String idTipo, String idNumero, String provincia, String canton, String distrito, String otrasSenias, String telefonoCodpais, String numTelefono, Set configuracionPlantillas, Set tiposCfds, Set conectorAdaptadors, Set configuracionesEmpresases, Set foliosEmpresases, Set tokens, Set sucursaleses, Set clienteses, Set configuracionesTokens, Set usuariosEmpresases) {
       this.nombre = nombre;
       this.status = status;
       ...
       this.conectorAdaptadors = conectorAdaptadors;
    ...
    public Set getConectorAdaptadors() {
        return this.conectorAdaptadors;
    }
    
    public void setConectorAdaptadors(Set conectorAdaptadors) {
        this.conectorAdaptadors = conectorAdaptadors;
    }
